...
<style>
	...
	.post :global(> *:nth-child(1)) { animation-delay: 100ms; }
	.post :global(> *:nth-child(2)) { animation-delay: 100ms; }
	.post :global(> *:nth-child(3)) { animation-delay: 500ms; }
	.post :global(> *:nth-child(4)) { animation-delay: 600ms; }
	.post :global(> *:nth-child(5)) { animation-delay: 700ms; }
	.post :global(> *:nth-child(6)) { animation-delay: 800ms; }
	.post :global(> *:nth-child(7)) { animation-delay: 900ms; }
	.post :global(> *:nth-child(8)) { animation-delay: 1000ms; }
	.post :global(> *:nth-child(9)) { animation-delay: 1100ms; }
	.post :global(> *:nth-child(10)) { animation-delay: 1200ms; }
	.post :global(> *:nth-child(n+11)) { animation-delay: 1300ms; }
