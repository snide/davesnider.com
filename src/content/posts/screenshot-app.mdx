---
title: Build your own sharable screenshot application
...
<video src="https://snid.es/2023OCT/Gkqv9goS~JIoAsju.mp4" controls />
...
<video src="https://snid.es/2023OCT/v5CY1XaojZjVXU6W.mp4" controls />
...
Here's the TypeScript file I use to watch for files, upload and scan in GCP, then store within my Xata database.
...
// This script assume you have a sibling `.env` file with the following environment variables set
// - XATA_API_KEY
// - XATA_BRANCH_NAME
// - GOOGLE_KEY_
...
<video src="https://snid.es/2023NOV/XAad8VmsV4QOzF97.mp4" controls />
