...
image: 'https://files.davesnider.com/cdn-cgi/image/w=1200,h=1200,fit=scale-down/2024OCT/vyYYEPni94Z1IE62.png'
---
...
Introducing the [Museum](/museum): two decades of my screenshots, now searchable. It's built with [Astro](https://astro.build), [Svelte](https://svelte.dev) and [Xata](https://xata.io). I'm planning a follow up post with build details for those that might want to build their own.
...
<FilesEmbed
  ...
  caption="A week of progression on a combo-box component I built with CJ Cenizal in 2017. Designs like this are hard to build out in Figma."
/>
...
<FilesEmbed
  ids={['69aa8d6b630', 'e0064e3ee68', '6774ec2d4bd', '4d0d3267526', '4278b506bbe', 'yK1tQCtDR9laSYak']}
  caption="Read the Docs, Webhook, Tested, Screened, Kibana, and Xata"
/>
