...
Introducing the [Museum](/museum): two decades of my screenshots, now searchable. It's built with [Astro](https://astro.build), [Svelte](https://svelte.dev) and [Xata](https://xatio.io). I'm planning a follow up post with build details for those that might want to build their own.
