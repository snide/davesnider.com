...
I went into 2025 with the goal of taking time off to work on [Table Slayer](https://tableslayer.com), a digital tabletop for running in-person RPG games on a TV. I ended up launching it in March and have steadily [improved it each month](https://tableslayer.com/changelog) since release. I also wanted to hit pause on working in a formal work environment and get back to my roots of building products from scratch, largely unassisted.
